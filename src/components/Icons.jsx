...
export const CoinIcon = ({ className, size }) => (
  <FaCoins className={className} size={size} />
);
export const HomeIcon = ({ className, size }) => (
  <FaHome className={className} size={size} />
);
export const WalletIcon = ({ className, size }) => (
  <FaWallet className={className} size={size} />
);
export const GiftIcon = ({ className, size }) => (
  <FaGift className={className} size={size} />
);
...
export const CrownIcon = ({ className, size }) => (
  <FaCrown className={className} size={size} />
);
export const MedalIcon = ({ className, size }) => (
  <FaMedal className={className} size={size} />
);
...
export const DeleteIcon = ({ className, size }) => (
  <FaTrash className={className} size={size} />
);
export const CheckIcon = ({ className, size }) => (
  <FaCheck className={className} size={size} />
);
export const TimesIcon = ({ className, size }) => (
  <FaTimes className={className} size={size} />
);
export const ShopIcon = ({ className, size }) => (
  <FaStore className={className} size={size} />
);
export const QuizIcon = ({ className, size }) => (
  <FaClipboardList className={className} size={size} />
);
export const BookIcon = ({ className, size }) => (
  <FaBook className={className} size={size} />
);
export const GradIcon = ({ className, size }) => (
  <FaGraduationCap className={className} size={size} />
);
export const TeacherIcon = ({ className, size }) => (
  <FaChalkboardTeacher className={className} size={size} />
);
export const FireIcon = ({ className, size }) => (
  <FaFire className={className} size={size} />
);
export const BulbIcon = ({ className, size }) => (
...
export const BellIcon = ({ className, size }) => (
  <FaBell className={className} size={size} />
);
export const SearchIcon = ({ className, size }) => (
  <FaFilter className={className} size={size} />
);
