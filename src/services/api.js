...
export const studentsAPI = {
  ...
  updateOne: (id, data) => request("PUT", `/students/${id}`, data),
  ...
  addCoins: (id, amount, label, category) =>
    request("POST", `/students/${id}/coins`, {
      amount,
      type: "earn",
      label,
      category,
...
export const quizzesAPI = {
  ...
  submitAttempt: (id, answers, timeTaken) =>
    request("POST", `/quizzes/${id}/submit`, { answers, timeTaken }),
...
export const scheduleAPI = {
  ...
  updateForClass: (classId, data) =>
    request("PUT", `/schedule/${classId}`, data),
