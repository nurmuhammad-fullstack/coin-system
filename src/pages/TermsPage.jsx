          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                By accessing and using {APP_NAME}, you accept and agree to be
                bound by the terms and provisions of this agreement.
                Additionally, when using {APP_NAME}&apos;s services, you shall
                be subject to any posted guidelines or rules applicable to those
                services.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="mb-3 text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                Permission is granted to temporarily use {APP_NAME} for
                personal, non-commercial educational use only. This is the grant
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                The content on {APP_NAME}, including but not limited to text,
                graphics, logos, images, audio clips, video clips, and software,
                is the property of {APP_NAME} and is protected by copyright
                laws. Unauthorized use of any content from this website is
                strictly prohibited.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-center gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-amber-500 rounded-full w-1.5 h-1.5" />
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-5 rounded-2xl text-white">
              ...
              <a
                href={`mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent(`${APP_NAME} Terms`)}`}
