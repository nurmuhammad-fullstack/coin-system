        ...
        <div className="space-y-4 pb-20">
          ...
          <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
              ...
              information when you use our educational platform. Please read
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-blue-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
                    <strong>Account Information:</strong> Name, email address,
                    password, role (student/teacher)
                  </span>
                </li>
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-blue-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
                    <strong>Profile Data:</strong> Avatar, color preferences,
                    class assignments
                  </span>
                </li>
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-blue-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
                    <strong>Learning Data:</strong> Quiz scores, coin balances,
                    quiz attempts, transaction history
                  </span>
                </li>
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-blue-500 mt-[7px] rounded-full w-1.5 h-1.5" />
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-green-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-purple-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
                    <strong>Teachers:</strong> Can view their students&apos;
                    progress, scores, and class assignments
                  </span>
                </li>
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-purple-500 mt-[7px] rounded-full w-1.5 h-1.5" />
                  <span>
                    <strong>Leaderboard:</strong> Student names and scores are
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                ...
                measures to protect your personal information. Your password is
                encrypted, and we use industry-standard encryption for data
                transmission. However, no method of transmission over the
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                ...
                deletion of your account at any time. We may also retain certain
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-2 text-slate-600 dark:text-slate-400 text-sm">
                  <span className="flex-shrink-0 bg-indigo-500 mt-[7px] rounded-full w-1.5 h-1.5" />
            ...
            <div className="bg-white dark:bg-slate-800 shadow-sm p-5 rounded-2xl">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                {APP_NAME} is designed for educational purposes and may be used
                by students under 13 with teacher supervision. We do not
            ...
            <div className="bg-gradient-to-r from-green-500 to-teal-500 p-5 rounded-2xl text-white">
              ...
              <a
                href={`mailto:${PRIVACY_EMAIL}?subject=${encodeURIComponent(`${APP_NAME} Privacy`)}`}
                className="inline-flex items-center gap-2 font-bold text-sm text-white hover:text-white/85 transition-colors"
              >
